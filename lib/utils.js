...
// This allows us to create a valid ACH date in the MMM D format
var formatDescriptiveDate = function(date) {
	return new Intl.DateTimeFormat('en', { month: 'short', day: '2-digit' }).format(date).toUpperCase();
	// return date.toLocaleDateString("en-US", { weekday: 'long', year: 'numeric', month: 'short', day: 'numeric' }).toUpperCase();
};
...
module.exports.formatDescriptiveDate = formatDescriptiveDate;
